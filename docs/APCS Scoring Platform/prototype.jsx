  ...
  return (
    <div className="screen" style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '24px 32px', maxWidth: 980, margin: '0 auto', width: '100%', flex: 1 }}>
        ...
        {/* Performance feedback — full width */}
        <div className="box" style={{ padding: 16 }}>
          <div className="row between" style={{ marginBottom: 8 }}>
            <span className="label">Performance feedback (for performer)</span>
          ...
          <textarea
            ...
            style={{ minHeight: 120, border: 'none', padding: 0, background: 'transparent' }} />
        </div>

        {/* Notes + Overall score — side by side */}
        <div className="row" style={{ gap: 14, marginTop: 14, alignItems: 'stretch' }}>
          <div className="box grow" style={{ padding: 16 }}>
            ...
            <textarea
              ...
              style={{ minHeight: 90, border: 'none', padding: 0, background: 'transparent' }} />
          </div>

          <div className="box" style={{ padding: 16, flex: '0 0 320px', display: 'flex', flexDirection: 'column', justifyContent: "flex-start" }}>
            <label className="label" htmlFor="score-input" style={{ marginBottom: 10 }}>Overall score</label>
